			...
			"undefined" != typeof self && self, a = function() {
				return function(t) {
							...
							$ = function() {
								...
								return e.hasClass = function(t) {
									...
									for (var r in this.italic > 0 && ((e = document.createElement("span"))
										.style.marginRight = this.italic + "em"), this.classes.length > 0 && ((e = e || document.createElement("span"))
										.className = A(this.classes)), this.style) this.style.hasOwnProperty(r) && ((e = e || document.createElement("span"))
						...
						var St = kt,
							...
							At = function(t, e) {
								var r;
								if (t.unit in zt) r = zt[t.unit] / e.fontMetrics()
									.ptPerEm / e.sizeMultiplier;
								else if ("mu" === t.unit) r = e.fontMetrics()
									.cssEmPerMu;
								else {
									var a;
									if (a = e.style.isTight() ? e.havingStyle(e.style.text()) : e, "ex" === t.unit) r = a.fontMetrics()
										.xHeight;
									else {
							...
							Lt = {
								...
								mathsym: function(t, e, r, a) {
									return void 0 === a && (a = []), "boldsymbol" === r.font && qt(t, "Main-Bold", e)
										.metrics ? Bt(t, "Main-Bold", e, r, a.concat(["mathbf"])) : "\\" === t || "main" === Y[e][t].font ? Bt(t, "Main-Regular", e, r, a) : Bt(t, "AMS-Regular", e, r, a.concat(["amsrm"]))
								},
								makeSpan: Ot,
								makeSvgSpan: It,
								makeLineSpan: function(t, e, r) {
									var a = Ot([t], [], e);
									return a.height = Math.max(r || e.fontMetrics()
										.defaultRuleThickness, e.minRuleThickness), a.style.borderBottomWidth = a.height + "em", a.maxFontSize = 1, a
								},
								...
								makeOrd: function(t, e, r) {
									...
									if (h) {
										...
										if (qt(o, d, n)
											.metrics) return Bt(o, d, n, e, s.concat(f));
						...
						function de(t, e) {
							...
							i.length > 0 && o.push(pe(i, e)), r && ((a = pe(se(r, e, !0)))
								.classes = ["tag"], o.push(a));
						...
						var _e = function(t) {
							...
							Ie = function(t, e) {
								...
								o ? (r = (a = Pt(o.base, "accent"))
										.base, o.base = r, n = function(t) {
											if (t instanceof C) return t;
											throw new Error("Expected span<HtmlDomNode> but got " + String(t) + ".")
										}(ue(o, e)), o.base = a) : r = (a = Pt(t, "accent"))
									.base;
								var i = ue(r, e.havingCrampedStyle()),
									s = 0;
								if (a.isShifty && c.isCharacterBox(r)) {
									var l = c.getBaseElem(r);
									s = L(ue(l, e.havingCrampedStyle()))
										.skew
								}
								var h, m = Math.min(i.height, e.fontMetrics()
									.xHeight);
								if (a.isStretchy) h = Oe(a, e), h = Lt.makeVList({
									...
									"\\vec" === a.label ? (u = Lt.staticSvg("vec", e), p = Lt.svgData.vec[1]) : ((u = L(u = Lt.makeOrd({
										...
										.italic = 0, p = u.width), h = Lt.makeSpan(["accent-body"], [u]);
						...
						Qt({
							...
							htmlBuilder: function(t, e) {
								...
								o.classes.push("x-arrow-pad"), t.below && (n = e.havingStyle(a.sub()), (r = Lt.wrapFragment(ue(t.below, n, e), e))
									.classes.push("x-arrow-pad"));
								var i, s = Oe(t, e),
									l = -e.fontMetrics()
									.axisHeight + .5 * s.height,
									h = -e.fontMetrics()
									.axisHeight - .5 * s.height - .111;
								if ((o.depth > .25 || "\\xleftequilibrium" === t.label) && (h -= o.depth), r) {
									var m = -e.fontMetrics()
										.axisHeight + r.height + .5 * s.height + .111;
									i = Lt.makeVList({
							...
							handler: function(t, e) {
								for (var r = t.parser, a = Pt(e[0], "ordgroup")
									.body, n = "", o = 0; o < a.length; o++) n += Pt(a[o], "textord")
									.text;
								var s = parseInt(n);
						...
						var Pe = function(t, e, r) {
							...
							Fe = function(t, e, r) {
								var a = e.havingBaseStyle(r),
									n = (1 - e.sizeMultiplier / a.sizeMultiplier) * e.fontMetrics()
									.axisHeight;
							...
							rr = function(t, e, r, a) {
								for (var n = Math.min(2, 3 - a.style.size); n < r.length && "stack" !== r[n].type; n++) {
									var o = Pe(t, er(r[n]), "math"),
										i = o.height + o.depth;
									if ("small" === r[n].type && (i *= a.havingBaseStyle(r[n].style)
										.sizeMultiplier), i > e) return r[n]
								}
								return r[r.length - 1]
							},
							...
							nr = function(t, e) {
								var r, a, n = e.havingBaseSizing(),
									...
									i = n.sizeMultiplier,
									s = Math.max(0, e.minRuleThickness - e.fontMetrics()
										.sqrtRuleThickness),
									l = 0,
									h = 0,
									m = 0;
								return "small" === o.type ? (t < 1 ? i = 1 : t < 1.4 && (i = .7), h = (1 + s) / i, (r = We("sqrtMain", l = (1 + s + .08) / i, m = 1e3 + 1e3 * s + 80, s, e))
									.style.minWidth = "0.853em", a = .833 / i) : "large" === o.type ? (m = 1080 * Ke[o.size], h = (Ke[o.size] + s) / i, l = (Ke[o.size] + s + .08) / i, (r = We("sqrtSize" + o.size, l, m, s, e))
									.style.minWidth = "1.02em", a = 1 / i) : (l = t + s + .08, h = t + s, m = Math.floor(1e3 * t + s) + 80, (r = We("sqrtTall", l, m, s, e))
									.style.minWidth = "0.742em", a = 1.056), r.height = h, r.style.height = l + "em", {
									span: r,
									advanceWidth: a,
									ruleWidth: (e.fontMetrics()
										.sqrtRuleThickness + s) * i
								}
							},
						...
						var ur = function(t, e) {
								...
								if ("sout" === o)(r = Lt.makeSpan(["stretchy", "sout"]))
									.height = e.fontMetrics()
									.defaultRuleThickness / i, s = -.5 * e.fontMetrics()
									.xHeight;
								else {
									/cancel/.test(o) ? l || n.classes.push("cancel-pad") : n.classes.push("boxpad");
									var h = 0,
										m = 0;
									/box/.test(o) ? (m = Math.max(e.fontMetrics()
											.fboxrule, e.minRuleThickness), h = e.fontMetrics()
										.fboxsep + ("colorbox" === o ? 0 : m)) : h = l ? .2 : 0, r = Ce(n, o, h, e), /fbox|boxed|fcolorbox/.test(o) && (r.style.borderStyle = "solid", r.style.borderWidth = m + "em"), s = n.depth + h, t.backgroundColor && (r.style.backgroundColor = t.backgroundColor, t.borderColor && (r.style.borderColor = t.borderColor))
								}
							...
							pr = function(t, e) {
								...
								switch (t.label) {
									...
									case "\\colorbox":
										if (r = e.fontMetrics()
											.fboxsep * e.fontMetrics()
											.ptPerEm, a.setAttribute("width", "+" + 2 * r + "pt"), a.setAttribute("height", "+" + 2 * r + "pt"), a.setAttribute("lspace", r + "pt"), a.setAttribute("voffset", r + "pt"), "\\fcolorbox" === t.label) {
											var n = Math.max(e.fontMetrics()
												.fboxrule, e.minRuleThickness);
						...
						function gr(t) {
							...
							for (var r = t.fetch()
									.text;
								"\\hline" === r || "\\hdashline" === r;) t.consume(), e.push("\\hdashline" === r), t.consumeSpaces(), r = t.fetch()
								.text;
							return e
						}
						...
						var br = function(t, e) {
								var r, a, n = t.body.length,
									...
									l = new Array(n),
									h = [],
									m = Math.max(e.fontMetrics()
										.arrayRuleWidth, e.minRuleThickness),
									u = 1 / e.fontMetrics()
									.ptPerEm,
									p = 5 * u;
								t.colSeparationType && "small" === t.colSeparationType && (p = e.havingStyle(w.SCRIPT)
									.sizeMultiplier / e.sizeMultiplier * .2778);
								var d = 12 * u,
									f = 3 * u,
									g = t.arraystretch * d,
									x = .7 * g,
								...
								for (a = 0, B = 0; a < s || B < N.length; ++a, ++B) {
									for (var I = N[B] || {}, $ = !0;
										"separator" === I.type;) {
										if ($ || ((q = Lt.makeSpan(["arraycolsep"], []))
											.style.width = e.fontMetrics()
											.doubleRuleSep + "em", O.push(q)), "|" !== I.separator && ":" !== I.separator) throw new i("Invalid separator type: " + I.separator);
									...
									if (!(a >= s)) {
										var D = void 0;
										(a > 0 || t.hskipBeforeAndAfter) && 0 !== (D = c.deflt(I.pregap, p)) && ((q = Lt.makeSpan(["arraycolsep"], []))
											.style.width = D + "em", O.push(q));
										var L = [];
										for (r = 0; r < n; ++r) {
											var P = l[r],
												H = P[a];
										...
										L = Lt.makeVList({
											positionType: "individualShift",
											children: L
										}, e), L = Lt.makeSpan(["col-align-" + (I.align || "c")], [L]), O.push(L), (a < s - 1 || t.hskipBeforeAndAfter) && 0 !== (D = c.deflt(I.postgap, p)) && ((q = Lt.makeSpan(["arraycolsep"], []))
											.style.width = D + "em", O.push(q))
									}
								}
							...
							wr = function(t, e) {
								...
								return /[sd]/.test(f) && r.setAttribute("rowlines", f.trim()), "" !== n && (r = new ve.MathNode("menclose", [r]))
									.setAttribute("notation", n.trim()), t.arraystretch && t.arraystretch < 1 && (r = new ve.MathNode("mstyle", [r]))
							...
							kr = function(t, e) {
								var r, a = [],
									...
									l = Ht(e[0], "ordgroup");
								if (l) {
									for (var h = "", m = 0; m < l.body.length; m++) h += Pt(l.body[m], "textord")
										.text;
									r = Number(h), o = 2 * r
								}
								var c = !o;
						...
						fr({
							...
							handler: function(t, e) {
								var r = {
									cols: (Vt(e[0]) ? [e[0]] : Pt(e[0], "ordgroup")
											.body)
										.map((function(t) {
											var e = Gt(t)
												.text;
							...
							handler: function(t, e) {
								var r = (Vt(e[0]) ? [e[0]] : Pt(e[0], "ordgroup")
										.body)
									.map((function(t) {
										var e = Gt(t)
											.text;
								...
								if ((a = xr(t.parser, a, "script"))
									.body[0].length > 1) throw new i("{subarray} can contain only one column");
								return a
							},
							htmlBuilder: br,
							mathmlBuilder: wr
						...
						Qt({
							...
							handler: function(t, e) {
								...
								for (var o = "", s = 0; s < n.body.length; ++s) o += Pt(n.body[s], "textord")
									.text;
								if ("\\begin" === a) {
						...
						function _r(t, e) {
							var r, a = ke(t.body, e);
							return "minner" === t.mclass ? ve.newDocumentFragment(a) : ("mord" === t.mclass ? t.isCharacterBox ? (r = a[0])
								.type = "mi" : r = new ve.MathNode("mi", a) : (t.isCharacterBox ? (r = a[0])
									.type = "mo" : r = new ve.MathNode("mo", a), "mbin" === t.mclass ? (r.attributes.lspace = "0.22em", r.attributes.rspace = "0.22em") : "mpunct" === t.mclass ? (r.attributes.lspace = "0em", r.attributes.rspace = "0.17em") : "mopen" !== t.mclass && "mclose" !== t.mclass || (r.attributes.lspace = "0em", r.attributes.rspace = "0em")), r)
						}
						Qt({
							type: "mclass",
						...
						var Cr = function(t, e) {
							...
							Nr = function(t, e) {
								...
								if (t.hasBarLine ? (t.barSize ? (m = At(t.barSize, e), h = Lt.makeLineSpan("frac-line", e, m)) : h = Lt.makeLineSpan("frac-line", e), m = h.height, c = h.height) : (h = null, m = 0, c = e.fontMetrics()
									.defaultRuleThickness), a.size === w.DISPLAY.size || "display" === t.size ? (u = e.fontMetrics()
									.num1, p = m > 0 ? 3 * c : 7 * c, d = e.fontMetrics()
									.denom1) : (m > 0 ? (u = e.fontMetrics()
										.num2, p = c) : (u = e.fontMetrics()
										.num3, p = 3 * c), d = e.fontMetrics()
									.denom2), h) {
									var y = e.fontMetrics()
										.axisHeight;
								...
								return r = e.havingStyle(a), f.height *= r.sizeMultiplier / e.sizeMultiplier, f.depth *= r.sizeMultiplier / e.sizeMultiplier, g = a.size === w.DISPLAY.size ? e.fontMetrics()
									.delim1 : e.fontMetrics()
									.delim2, x = null == t.leftDelim ? ce(e, ["mopen"]) : ir(t.leftDelim, g, !0, e.havingStyle(a), t.mode, ["mopen"]), v = t.continued ? Lt.makeSpan([]) : null == t.rightDelim ? ce(e, ["mclose"]) : ir(t.rightDelim, g, !0, e.havingStyle(a), t.mode, ["mclose"]), Lt.makeSpan(["mord"].concat(r.sizingClasses(e)), [x, Lt.makeSpan(["mfrac"], [f]), v], e)
							},
							Or = function(t, e) {
						...
						var Er = function(t, e) {
							...
							if (a.isOver ? (i = Lt.makeVList({
								...
								.children[0].children[0].children[1].classes.push("svg-align") : (i = Lt.makeVList({
									positionType: "bottom",
						...
						Qt({
							...
							handler: function(t, e, r) {
								var a = t.parser,
									...
									l = "";
								if (r[0])
									for (var h = Pt(r[0], "raw")
										.string.split(","), m = 0; m < h.length; m++) {
										var c = h[m].split("=");
										if (2 === c.length) {
											var u = c[1].trim();
											switch (c[0].trim()) {
							...
							mathmlBuilder: function(t, e) {
								...
								var a = At(t.height, e),
									n = 0;
								if (t.totalheight.number > 0 && (n = (n = At(t.totalheight, e) - a)
									.toFixed(2), r.setAttribute("valign", "-" + n + "em")), r.setAttribute("height", a + n + "em"), t.width.number > 0) {
									var o = At(t.width, e);
						...
						var Lr = function(t, e, r, a, n, o, i) {
								...
								if (t = Lt.makeSpan([], [t]), e) {
									...
									l = {
										elem: m,
										kern: Math.max(a.fontMetrics()
											.bigOpSpacing1, a.fontMetrics()
											.bigOpSpacing3 - m.depth)
									}
								}
								if (r) {
									...
									s = {
										elem: c,
										kern: Math.max(a.fontMetrics()
											.bigOpSpacing2, a.fontMetrics()
											.bigOpSpacing4 - c.height)
									}
								}
								if (l && s) {
									var u = a.fontMetrics()
										.bigOpSpacing5 + s.elem.height + s.elem.depth + s.kern + t.depth + i;
									h = Lt.makeVList({
										positionType: "bottom",
										positionData: u,
										children: [{
							...
							Hr = function(t, e) {
								...
								if (l.size === w.DISPLAY.size && n.symbol && !c.contains(Pr, n.name) && (h = !0), n.symbol) {
									...
									var f = se(n.body, e, !0);
									1 === f.length && f[0] instanceof $ ? (s = f[0])
										.classes[0] = "mop" : s = Lt.makeSpan(["mop"], Lt.tryCombineChars(f), e)
								} else {
								...
								var v = 0,
									b = 0;
								return (s instanceof $ || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (v = (s.height - s.depth) / 2 - e.fontMetrics()
									.axisHeight, b = s.italic), o ? Lr(s, r, a, e, l, b, v) : (v && (s.style.position = "relative", s.style.top = v + "em"), s)
							},
							Fr = function(t, e) {
								var r;
							...
							mathmlBuilder: function(t, e) {
								for (var r = ke(t.body, e.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
									...
									if (o instanceof ve.SpaceNode);
										...
										case "mo":
											var i = o.children[0];
											1 === o.children.length && i instanceof ve.TextNode ? i.text = i.text.replace(/\u2212/, "-")
												.replace(/\u2217/, "*") : a = !1;
											break;
										default:
											a = !1
						...
						Qt({
							...
							htmlBuilder: function(t, e) {
								var r = ue(t.body, e.havingCrampedStyle());
								0 === r.height && (r.height = e.fontMetrics()
									.xHeight), r = Lt.wrapFragment(r, e);
								var a = e.fontMetrics()
									.defaultRuleThickness,
									n = a;
								e.style.id < w.TEXT.id && (n = e.fontMetrics()
									.xHeight);
								var o = a + n / 4,
						...
						Qt({
							...
							htmlBuilder: function(t, e) {
								...
								if (s) {
									...
									a = ue(s, f, e), d || (u = h.height - f.fontMetrics()
										.supDrop * f.sizeMultiplier / e.sizeMultiplier)
								}
								if (l) {
									var g = e.havingStyle(e.style.sub());
									n = ue(l, g, e), d || (p = h.depth + g.fontMetrics()
										.subDrop * g.sizeMultiplier / e.sizeMultiplier)
								}
						...
						ca("\\char", (function(t) {
							...
							if (e) {
								...
								for (var n; null != (n = ua[t.future()
									.text]) && n < e;) a *= e, a += n, t.popToken()
							}
							return "\\@char{" + a + "}"
						}));
						var pa = function(t, e) {
							...
							for (r = t.consumeArgs(1)[0]; 1 === r.length && "#" === r[0].text;) {
								if (1 !== (r = t.consumeArgs(1)[0])
									.length) throw new i('Invalid argument number length "' + r.length + '"');
						...
						var va = {
							...
							ba = function() {
								...
								return e.feed = function(t) {
									...
									var a = r.tokens;
									if (r.numArgs)
										for (var n = this.consumeArgs(r.numArgs), o = (a = a.slice())
											.length - 1; o >= 0; --o) {
											var s = a[o];
											if ("#" === s.text) {
												...
												if ("#" === (s = a[--o])
													...
													var l;
													(l = a)
													.splice.apply(l, [o, 2].concat(n[+s.text - 1]))
												}
											}
										}
							...
							ka = function() {
								...
								return e.expect = function(t, e) {
									if (void 0 === e && (e = !0), this.fetch()
										.text !== t) throw new i("Expected '" + t + "', got '" + this.fetch()
										.text + "'", this.fetch());
									e && this.consume()
								}, e.consume = function() {
									this.nextToken = null
									...
									for (;;) {
										...
										if ("\\limits" === n.text || "\\nolimits" === n.text) {
											...
											for (this.consume();
												"'" === this.fetch()
												.text;) m.push(h), this.consume();
											"^" === this.fetch()
												.text && m.push(this.handleSupSubscript("superscript")), e = {
													type: "ordgroup",
													mode: this.mode,
													body: m
												}
									...
									switch (e) {
										...
										case "raw":
											if (n && this.consumeSpaces(), r && "{" === this.fetch()
												.text) return null;
									...
									var e, r = !1;
									if (!(e = t || "{" === this.fetch()
										.text ? this.parseStringGroup("size", t) : this.parseRegexGroup(/^[-+]? *(?:$|\d+|\d+\.\d*|\.\d*) *[a-z]{0,2} *$/, "size"))) return null;
				...
				_go2: function(t) {
					...
					switch (t.type_) {
						...
						case "rm":
							...
							break;
						case "text":
							t.p1.match(/[\^_]/) ? (t.p1 = t.p1.replace(" ", "~")
								.replace("-", "\\text{-}"), e = "\\mathrm{" + t.p1 + "}") : e = "\\text{" + t.p1 + "}";
							break;
						case "roman numeral":
							e = "\\mathrm{" + t.p1 + "}";
							break;
					...
					t.beforeEach(t => {
						let e = t.replace(/<code>(.*)<\/code>/g, (function(t, e) {
								...
								return e = e.replace(u, "$ `$")
									.replace(p, "\\`{"), e = e.replace(/(\$\$)([\s\S]*?)(\$\$)/g, (function(t, e, r) {
