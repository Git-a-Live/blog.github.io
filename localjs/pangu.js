    ...
    return function(e) {
            ...
            var c = function(e) {
                    function t() {
                        ...
                        return function(e, t) {
                                ...
                                .call(this)))
                            .blockTags = /^(div|p|h1|h2|h3|h4|h5|h6)$/i, e.ignoredTags = /^(script|code|pre|textarea)$/i, e.presentationalTags = /^(b|code|del|em|i|s|strong)$/i, e.spaceLikeTags = /^(br|hr|i|img|pangu)$/i, e.spaceSensitiveTags = /^(a|del|pre|s|strike|u)$/i, e.isAutoSpacingPageExecuted = !1, e
                    }
                    return function(e, t) {
                        ...
                        value: function(e, t) {
                            ...
                            for (; a.parentNode;)
                                if (a = a.parentNode, this.isSpecificTag(a, t)) return !0;
                            return !1
                        }
                    }, {
                        key: "canIgnoreNode",
                        value: function(e) {
                            ...
                            for (; t.parentNode;)
                                if ((t = t.parentNode) && (this.isSpecificTag(t, this.ignoredTags) || this.isContentEditable(t))) return !0;
                            return !1
                        }
                    }, {
                                ...
                                for (var n, a, i = document.evaluate(e, t, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null), o = i.snapshotLength - 1; o > -1; --o) {
                                    if (n = i.snapshotItem(o), this.isSpecificTag(n.parentNode, this.presentationalTags) && !this.isInsideSpecificTag(n.parentNode, this.ignoredTags)) {
                                        ...
                                        if (r.previousSibling) {
                                            ...
                                            if (c.nodeType === Node.TEXT_NODE) {
                                                var s = c.data.substr(-1) + n.data.toString()
                                                    .charAt(0),
                                                    u = this.spacing(s);
                                        ...
                                        if (r.nextSibling) {
                                            ...
                                            if (p.nodeType === Node.TEXT_NODE) {
                                                var l = n.data.substr(-1) + p.data.toString()
                                                    .charAt(0),
                                                    f = this.spacing(l);
                                    ...
                                    if (this.canIgnoreNode(n)) a = n;
                                        ...
                                        if (n.data !== g && (n.data = g), a) {
                                            ...
                                            var d = n.data.toString()
                                                .substr(-1) + a.data.toString()
                                                .substr(0, 1),
                                                h = this.spacing(d);
                                            if (h !== d) {
                                                ...
                                                if (-1 === v.nodeName.search(this.blockTags))
                                                    if (-1 === y.nodeName.search(this.spaceSensitiveTags)) - 1 === y.nodeName.search(this.ignoredTags) && -1 === y.nodeName.search(this.blockTags) && (a.previousSibling ? -1 === a.previousSibling.nodeName.search(this.spaceLikeTags) && (a.data = " ".concat(a.data)) : this.canIgnoreNode(a) || (a.data = " ".concat(a.data)));
                        ...
                        value: function() {
                            ...
                            ["script", "style", "textarea"].forEach(function(t) {
                                e = "".concat(e, '[translate(name(..),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz")!="')
                                    .concat(t, '"]')
        ...
        i = [], void 0 === (o = "function" == typeof(a = function() {
            ...
            var a = "⺀-⻿⼀-⿟぀-ゟ゠-ヺー-ヿ㄀-ㄯ㈀-㋿㐀-䶿一-鿿豈-﫿",
                ...
                N = /([\(\[\{<\u201c]+)[ ]*(.+?)[ ]*([\)\]\}>\u201d]+)/,
                w = new RegExp("([A-Za-z0-9".concat(a, "])[ ]*([“])([A-Za-z0-9")
                    .concat(a, "\\-_ ]+)([”])"), "g"),
                k = new RegExp("([“])([A-Za-z0-9".concat(a, "\\-_ ]+)([”])[ ]*([A-Za-z0-9")
                    .concat(a, "])"), "g"),
                P = /([A-Za-z0-9])([\(\[\{])/g,
                O = /([\)\]\}])([A-Za-z0-9])/g,
