! function(t) {
	...
	h && p || (h = function(t) {
		...
		.port2, o.port1.onmessage = w, e = a(i.postMessage, i, 1)) : f.addEventListener && "function" == typeof postMessage && !f.importScripts ? (e = function(t) {
		f.postMessage(t + "", "*")
	}, f.addEventListener("message", w, !1)) : e = "onreadystatechange" in s("script") ? function(t) {
		c.appendChild(s("script"))
	...
	if (r(5)) {
		var e = r(16),
			...
			_t = i(function() {
				return 1 === new $(new Uint16Array([1])
					.buffer)[0]
			}),
			...
			Lt = function(t) {
				var n, r, e, o, i, a, u = _(t),
					...
					h = O(u);
				if (null != h && !E(h)) {
					for (a = h.call(u), e = [], n = 0; !(i = a.next())
						.done; n++) e.push(i.value);
					u = e
				}
		...
		p(Dt, Bt), h(Dt, vt, Bt.values), p(Dt, {
			...
			h(v, gt, !0), h(E, wt, s), h(E, xt, !0), h(E, yt, v), (c ? new v(1)[dt] == s : dt in E) || D(E, dt, {
				...
				return [1, 2].toLocaleString() != new v([1, 2])
					.toLocaleString()
			}) || !i(function() {
	...
	var e = r(2),
		...
		c = function() {
			var t, n = r(33)("iframe"),
				e = i.length;
			for (n.style.display = "none", r(51)
				.appendChild(n), n.src = "javascript:", (t = n.contentWindow.document)
				.open(), t.write("<script>document.F=Object<\/script>"), t.close(), c = t.F; e--;) delete c.prototype[i[e]];
			return c()
		};
	...
	r(32)("split", 2, function(t, n, r, f) {
		var v;
		return v = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)
	...
	t.exports = !s || r(9)(function() {
		...
		return t[r] = 7, e.split("")
			.forEach(function(t) {
				n[t] = t
			}), 7 != s({}, t)[r] || Object.keys(s({}, n))
			.join("") != e
	}) ? function(t, n) {
		for (var r = u(t), s = arguments.length, f = 1, l = i.f, h = a.f; s > f;)
			for (var p, v = c(arguments[f++]), d = l ? o(v)
				.concat(l(v)) : o(v), g = d.length, y = 0; g > y;) p = d[y++], e && !h.call(v, p) || (r[p] = v[p]);
		return r
	} : s
}, function(t, n) {
	...
	var e, o, i, a, u = r(16),
		...
		B = function(t) {
			...
			n._d || (n._d = !0, (n = n._w || n)
				._v = t, n._s = 2, n._a || (n._a = n._c.slice()), T(n, !0))
		},
		N = function(t) {
			var n, r = this;
			if (!r._d) {
	...
	F || (O = function(t) {
			...
			Promise: O
		}), r(26)(O, "Promise"), r(53)("Promise"), a = r(15)
	...
	var e = function(t) {
					...
					return new Promise(function(n, i) {
						! function n(r, o, i, a) {
							...
							if ("throw" !== u.type) {
								var c = u.arg,
									f = c.value;
								return f && "object" == typeof f && e.call(f, "__await") ? Promise.resolve(f.__await)
									.then(function(t) {
										n("next", t, i, a)
									}, function(t) {
										n("throw", t, i, a)
		...
		return g.prototype = b.constructor = y, y.constructor = g, y[u] = g.displayName = "GeneratorFunction", t.isGeneratorFunction = function(t) {
			...
			return t.isGeneratorFunction(r) ? i : i.next()
				.then(function(t) {
		...
		function t(n) {
			...
			! function(t, n) {
				...
				return function() {
					...
					.map(function(n) {
						var r;
						return (r = t.frameInfo(n))
							.pixels = new Uint8ClampedArray(t.width * t.height * 4), t.decodeAndBlitFrameRGBA(n, r.pixels), r
					})
		...
		return n = t, (r = [{
			...
			value: function() {
				return this.lastTime = (new Date)
					.valueOf(), this.delayCompensation = 0, this.running = !0, setTimeout(this.nextFrame.bind(this), 0), this
			}
		}, {
			key: "stop",
			value: function() {
			...
			value: function() {
				...
				for (this.advanceFrame(); this.running;) {
					if (r = this.frames[this.frameIndex], n = (new Date)
						.valueOf() - this.lastTime, this.lastTime += n, this.delayCompensation += n, t = (e = 10 * r.delay) - this.delayCompensation, this.delayCompensation -= e, !(t < 0)) {
			...
			value: function(t, n) {
				...
				return null == n && (n = !0), n && (t.width = this.width, t.height = this.height, t.parentNode.style.width = this.width + "px", t.parentNode.style.height = this.height + "px"), r = t.getContext("2d"), null == this.onDrawFrame && (this.onDrawFrame = function(t, n, r) {
					...
					switch (null == n.buffer && (n.buffer = function(t, n, r) {
						var e, o, i;
						return o = (e = document.createElement("canvas"))
							.getContext("2d"), e.width = t.width, e.height = t.height, (i = o.createImageData(n, r))
							.data.set(t.pixels), o.putImageData(i, -t.x, -t.y), e
	...
	window.$docsify || (window.$docsify = {}), window.$docsify.plugins || (window.$docsify.plugins = {}), window.$docsify.plugins = [].concat(function(t, n) {
		t.doneEach(function(t) {
			...
			.forEach(function(t) {
					...
					s.style.backgroundColor = e.overlayColor, s.classList.add("gifcontrol-error-element"), s.style.color = e.errorTextColor, s.innerHTML = "".concat(e.errorIcon, ' <div class="gifcontrol-errortext">')
